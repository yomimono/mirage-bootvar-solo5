...
(* OASIS_START *)
(* DO NOT EDIT (digest: a7d4d6a9c4dc7434789f3382795a9c07) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Dan Williams"; "Magnus Skjegstad"; "Martin Lucina"];
          homepage = None;
          bugreports = None;
          synopsis =
            "Library for reading MirageOS unikernel boot parameters in Solo5";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-solo5", None);
                           FindlibPackage ("bos", None)
                        ];
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mirage-bootvar";
     ...
     oasis_version = "0.4.7";
     oasis_digest =
       Some "\000\028jU\186$\\\139\214\223\221\162\226\027\128\229";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
